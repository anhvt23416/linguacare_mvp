...
CREATE CONSTRAINT vocab_uuid IF NOT EXISTS
FOR (n:VocabularyNode)
REQUIRE n.uuid IS UNIQUE;
CREATE CONSTRAINT grammar_uuid IF NOT EXISTS
FOR (n:GrammarNode)
REQUIRE n.uuid IS UNIQUE;
...
CREATE INDEX vocab_form IF NOT EXISTS
FOR (n:VocabularyNode)
ON (n.canonical_form);
CREATE INDEX vocab_cefr IF NOT EXISTS
FOR (n:VocabularyNode)
ON (n.cefr_level);
CREATE INDEX grammar_cefr IF NOT EXISTS
FOR (n:GrammarNode)
ON (n.cefr_level);
